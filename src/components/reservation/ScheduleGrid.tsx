...
export function ScheduleGrid({
  ...
  return (
    <div
      ref={gridRef}
      className={`w-full flex-1 border-t border-gray-200 text-sm flex relative bg-white select-none ${canReserve ? (selectionInfo.isTouchDrag ? 'overflow-hidden touch-none' : 'overflow-y-visible lg:overflow-y-auto') : 'overflow-hidden'
        }`}
