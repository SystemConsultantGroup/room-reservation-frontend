  ...
  return (
    <div className="flex-1 flex flex-col h-full overflow-hidden">
      ...
      {isSummariesLoading || isRoomLoading ? (
        ...
        <div className="p-4 xl:p-10 pb-4 flex-1 overflow-y-auto xl:overflow-hidden flex flex-col xl:flex-row gap-6 xl:gap-8 h-full">
          {/* Schedule */}
          <Card className="w-full xl:flex-1 flex flex-col h-fit xl:h-full relative !p-6 xl:!p-8 xl:overflow-hidden">

            <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 xl:mb-8 gap-4 relative flex-wrap">
              <RoomSelector rooms={summaries?.rooms || []} currentRoomId={roomId} />

              <div className="flex border rounded border-gray-200 overflow-hidden shadow-sm bg-white font-extrabold text-xs sm:text-xs tracking-tight text-gray-800 w-fit">
                <button
          ...
          {/* Info Panel */}
          <div className="w-full xl:w-[360px] xl:shrink-0 h-auto xl:h-full flex flex-col">
