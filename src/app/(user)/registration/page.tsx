              ...
              <div className="space-y-3">
                {history.applications.length > 0 ? (
                  history.applications.map((app) => (
                    <div key={app.id} className="flex items-center justify-between p-4 bg-bg-base rounded-2xl border border-ui-border transition-all hover:border-gray-200">
                  ...
                  <div className="py-12 border border-dashed border-ui-border rounded-2xl flex flex-col items-center justify-center bg-bg-base/30">
